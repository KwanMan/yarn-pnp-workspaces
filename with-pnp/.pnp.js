...
let packageInformationStores = new Map([
  ["build-script", new Map([
    ["1.0.0", {
      packageLocation: path.resolve(__dirname, "./packages/build-script/"),
  ...
  ["package-a", new Map([
    ["1.0.0", {
      packageLocation: path.resolve(__dirname, "./packages/package-a/"),
      packageDependencies: new Map([
        ["build-script", "1.0.0"],
      ]),
    }],
...
let locatorsByLocations = new Map([
  ["./packages/build-script/", {"name":"build-script","reference":"1.0.0"}],
  ["./packages/package-a/", {"name":"package-a","reference":"1.0.0"}],
  ["./", topLevelLocator],
]);
exports.findPackageLocator = function findPackageLocator(location) {
  ...
  if (relativeLocation.length >= 24 && relativeLocation[23] === '/')
    if (match = locatorsByLocations.get(relativeLocation.substr(0, 24)))
